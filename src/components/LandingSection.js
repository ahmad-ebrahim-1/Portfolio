...
import { Image, Heading, HStack, VStack, Button } from "@chakra-ui/react";
      ...
      <HStack spacing="124px">
        <VStack alignItems="flex-start" spacing={6}>
          <VStack alignItems="flex-start">
            <Heading id="about-section" fontWeight="normal" size="xl">{greeting}</Heading>
            <Heading
              className="text"
              fontSize="96px">
              {name}!
          ...
          <VStack alignItems="flex-start">
            <VStack alignItems="flex-start" spacing={4}>
              <Heading fontWeight="normal" size="2xl">{bio1}</Heading>
              <Heading fontWeight="normal" size="2xl">{bio2}</Heading>
            </VStack>
          </VStack>
        </VStack>
